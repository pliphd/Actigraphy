...
classdef ImportWizard < handle
    ...
    methods (Access = public)
        function app = ImportWizard(varargin)
    ...
    methods (Access = private)
        function createComponents(app)
            ...
            app.RunModeDropdown = uidropdown(gImportOptions, 'Items', {'Circadian', 'Gap', 'Nap', 'Sleep'}, ...
                'ItemsData', 1:4, 'Value', 2);
    ...
    methods (Access = private)
        ...
        function app = separatorChanged(app, source, event)
            ...
            app.configStruct.FileNameSeperator = app.filenameSeparator;
        end
    ...
    methods
        ...
        function app = loadConfig(app, configStruct, selectedFiles)
            ...
            function app = popCheckers(app, sep)
                ...
                app.DecoderText.Text = "Defined separator(s): " + sep_;
            end
        end
