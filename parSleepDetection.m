...
tbl.Properties.VariableNames = {'filename', ...
    ...
    ['sleep_frequency_' replace(option.sleepWindow.StartTime, ':', '') '_' replace(option.sleepWindow.EndTime, ':', '') '_avg'], ...
    ['numbers_awake_' replace(option.sleepWindow.StartTime, ':', '') '_' replace(option.sleepWindow.EndTime, ':', '') '_avg'], ...
    ['waso_in_min_' replace(option.sleepWindow.StartTime, ':', '') '_' replace(option.sleepWindow.EndTime, ':', '') '_avg']};
