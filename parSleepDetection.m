...
tbl.Properties.VariableNames = {'filename', ...
    ['sleep_duration_gap_out_' replace(option.sleepWindow.StartTime, ':', '') '_' replace(option.sleepWindow.EndTime, ':', '') '_avg'], ...
    ['numbers_awake_gap_out_' replace(option.sleepWindow.StartTime, ':', '') '_' replace(option.sleepWindow.EndTime, ':', '') '_avg'], ...
    ['sleep_duration_' replace(option.sleepWindow.StartTime, ':', '') '_' replace(option.sleepWindow.EndTime, ':', '') '_avg'], ...
    ['numbers_awake_' replace(option.sleepWindow.StartTime, ':', '') '_' replace(option.sleepWindow.EndTime, ':', '') '_avg']};
